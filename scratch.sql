...
INSERT INTO league (name, code, icon) VALUES ('Primera División', 'PDN', 'https://upload.wikimedia.org/wikipedia/commons/9/92/LaLiga_Santander.svg');
...
SELECT id, name, code, icon from league;
